...
- Required runtime tools under the app root are `tools\mozjpeg[-version...]\static\Release\cjpeg-static.exe`, `tools\oxipng[-version...]\oxipng.exe`, `tools\pngquant[-version...]\pngquant.exe`, `tools\vips-dev[-version...]\bin\vips.exe`, and `tools\vips-dev[-version...]\bin\vipsheader.exe`.
